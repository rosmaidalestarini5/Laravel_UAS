...
->middleware('can:isKonsumen');
Route::get('konsumen/alamatkirim/default/{id}',
...
Route::post('resto/siap/{id}', [App\Http\Controllers\resto\JualControler::class,
...
Route::post('resto/track/{id}', [App\Http\Controllers\resto\JualController::class,
...
->middleware('can:isResto');
Route::get('pizza_resource/{filename}', function ($filename)
{
