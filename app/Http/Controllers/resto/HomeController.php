...
{
    protected $_arr_status_jual = ['RESPON', 'SIAP', 'PROSES', 'PESAN', 'BERJALAN', 'SELESAI', 'BATAL'];
    ...
    public function index(Request $request) 
    {
        ...
        $peminat_50 = Jual::whereRaw("status_jual='TIBA'", [])->orderBy('waktu_pesan', 'desc')
        ->take(50)->avg('resto_rate');
        $peminat_semua = Jual::whereRaw("status_jual='TIBA'", [])->avg('resto_rate');
        return view('resto.home.index', compact('juals','status_jual','arr_status_jual',
        'jual', 'rating_50', 'rating_semua','order_minggu_terakhir','order_bulan_ini','peminat_50','peminat_semua'));
    }
}